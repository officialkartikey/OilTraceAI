...
exports.seedDeterministicAis = seedDeterministicAis;
const AisRecord_1 = require("../models/AisRecord");
function seedDeterministicAis() {
    return __awaiter(this, void 0, void 0, function* () {
        const count = yield AisRecord_1.AisRecord.countDocuments();
        if (count > 0) {
        ...
        yield AisRecord_1.AisRecord.insertMany(records);
